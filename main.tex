...
The expected contribution is a practical engineering framework that helps the university process maintenance requests more consistently and efficiently than current manual practice, while remaining feasible for a student project and aligned with the EC7109 proposal format.
\newpage
